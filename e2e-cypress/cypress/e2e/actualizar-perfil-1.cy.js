...
describe('Create a post', () => {
    ...
    it(`SETTINGS-1 As a user I log in, 
    I enter to profile settings,
    I fill the location field with a new location with 151 caracters,
    I fill the website field with a new website,
    I fill the X field with a new twitter account,
    I fill the bio field with a new bio,
