...
describe('EA2 - Creación de tag con SLUG con caracteres especiales', () => {
  ...
  `, () => {
        ...
        const nameTag = tagDataMockaroo[9].name_tag;
        const slugTag = tagDataMockaroo[9].slug;
        const descriptionTag = tagDataMockaroo[9].description;
        const colorTag = (tagDataMockaroo[9].color).replace('#', '');
